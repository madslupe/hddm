...
class HDDMnn_weibull(HDDM):
    ...
    def _create_stochastic_knodes(self, include):
        ...
        if self.free:
            ...
            knodes.update(self._create_family_trunc_normal('beta', lower=0.3, upper=7, std_lower = 1e-3, std_upper=2, value=1))
            if self.k:
                knodes.update(self._create_family_trunc_normal('alpha', lower=0.3, upper=5, std_lower = 1e-3, std_upper=2, value=1))
        return knodes
