...
class HDDMall(HDDM):
    ...
    def _create_wfpt_knode(self, knodes):
        ...
        return Knode(self.wfpt_all_class, 'wfpt', observed=True, col_name=['rt', 'zpos','zneg','dgroup','dsess','ztrain'], **wfpt_parents)


def wienerALL_like(x, v, sv, a, z, sz, t, st,b_v_zpos, b_v_zneg, b_v_dgroup, b_v_ztrain, b_v_zpos_dgroup, b_v_zneg_dgroup, b_v_zpos_ztrain, b_v_zneg_ztrain, b_v_dgroup_ztrain, b_v_zpos_dgroup_ztrain, b_v_zneg_dgroup_ztrain, b_a_dgroup, b_a_ztrain, b_a_dgroup_ztrain, b_t_dgroup, b_t_ztrain, b_t_dgroup_ztrain, b_z_dgroup, b_z_ztrain, b_z_dgroup_ztrain, p_outlier=0):
    ...
    return wiener_like_all(x['rt'].values, zpos, zneg, dgroup, dsess, ztrain, b_v_zpos, b_v_zneg, b_v_dgroup, b_v_ztrain, b_v_zpos_dgroup, b_v_zneg_dgroup, b_v_zpos_ztrain, b_v_zneg_ztrain, b_v_dgroup_ztrain, b_v_zpos_dgroup_ztrain, b_v_zneg_dgroup_ztrain, b_a_dgroup, b_a_ztrain, b_a_dgroup_ztrain, b_t_dgroup, b_t_ztrain, b_t_dgroup_ztrain, b_z_dgroup, b_z_ztrain, b_z_dgroup_ztrain, v, sv, a, z, sz, t, st, p_outlier=p_outlier, **wp)
