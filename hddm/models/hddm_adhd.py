...
class HDDMadhd(HDDM):
    ...
    def _create_wfpt_knode(self, knodes):
        ...
        return Knode(self.wfpt_adhd_class, 'wfpt', observed=True, col_name=['rt', 'zpos','zneg','dmed','dsess','ztrain'], **wfpt_parents)


def wienerADHD_like(x, v, sv, a, z, sz, t, st,b_v_zpos, b_v_zneg, b_v_dmed, b_v_ztrain, b_v_zpos_dmed, b_v_zneg_dmed, b_v_zpos_ztrain, b_v_zneg_ztrain, b_v_dmed_ztrain, b_v_zpos_dmed_ztrain, b_v_zneg_dmed_ztrain, b_a_dmed, b_a_ztrain, b_a_dmed_ztrain, b_t_dmed, b_t_ztrain, b_t_dmed_ztrain, b_z_dmed, b_z_ztrain, b_z_dmed_ztrain, p_outlier=0):
    ...
    return wiener_like_adhd(x['rt'].values, zpos, zneg, dmed, dsess, ztrain, b_v_zpos, b_v_zneg, b_v_dmed, b_v_ztrain, b_v_zpos_dmed, b_v_zneg_dmed, b_v_zpos_ztrain, b_v_zneg_ztrain, b_v_dmed_ztrain, b_v_zpos_dmed_ztrain, b_v_zneg_dmed_ztrain, b_a_dmed, b_a_ztrain, b_a_dmed_ztrain, b_t_dmed, b_t_ztrain, b_t_dmed_ztrain, b_z_dmed, b_z_ztrain, b_z_dmed_ztrain, v, sv, a, z, sz, t, st, p_outlier=p_outlier, **wp)
